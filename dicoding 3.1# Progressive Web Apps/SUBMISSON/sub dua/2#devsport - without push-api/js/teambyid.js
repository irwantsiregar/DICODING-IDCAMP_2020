   ...
   <div class="col s12 m6 l4 card-team">
        <div class="card grey lighten-5">
          <div class="container" style="padding-top: 10px;">
            <div><span class="card-title activator grey-text text-darken-4">${data.name}<i class="material-icons right">more_vert</i><i class="material-icons right">visibility</i></span></div>
          </div>
