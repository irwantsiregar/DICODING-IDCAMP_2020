           ...
           <div class="col s12 m7 l4 card-team">
              <div class="card horizontal responsive">
                <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="${team.crestUrl}" width="40px" alt="${team.name}">
                </div>
                <div class="card-content">
                  <ul class="collection with-header">
                    <li class="collection-header"><h5><span class="card-title activator grey-text text-darken-4">${team.name} | ${team.tla}<i class="material-icons right">more_vert</i></span></h5></li>
