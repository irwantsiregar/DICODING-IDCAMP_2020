...
function getMatches(data) {
  ...
  let titleMatchHTML = `<h6>MATCHES : ${data.competition.name.toUpperCase()} - ${data.competition.area.name.toUpperCase()} <span class="badge grey darken-4 hide-on-small-only"><i class="large material-icons white-text" style="font-size: 23px;">sports_soccer</i></span></h6>`;
