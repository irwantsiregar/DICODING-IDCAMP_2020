...
function getStanding(data) {
  ...
  let competitionHTML = `<h6>STANDINGS : ${data.competition.name.toUpperCase()} - ${data.competition.area.name.toUpperCase()} <span class="badge grey darken-4"><i class="large material-icons white-text" style="font-size: 23px;">sports_soccer</i></span></h6>`;
