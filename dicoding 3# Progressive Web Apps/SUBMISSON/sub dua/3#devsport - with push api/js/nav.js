    ...
    xhttp.onreadystatechange = function() {
      if (this.readyState === 4) {
        ...
        if (this.status === 200) {
          ...
          bodyContent.innerHTML = `<div class="container"><h4 class="amber-text"><i class="material-icons left">announcement</i>Page not found</h4></div>
`;
        } else {
          bodyContent.innerHTML = `<div class="container"><h4 class="red-text"><i class="material-icons left">notification_important</i>Can't accessed page</h4></div>
`;
        }
