...
const createMenuDetailTemplate = (detailMenu) => `
        <div class="detail-card">
            ...
            <div class="detail-text">
                ...
                <h4 class="title-item__detail">Categories</h4>
                <ul class="ul-list">
                ${detailMenu.categories.map((category) => ` ⸰${category.name}`).join(' | ')}
                </ul>
                <h4 class="title-item__detail">Menus</h4>
                <h4>🗸Foods</h4>
                <ul class="ul-list">
                ...
                <h4 class="title-item__detail">Description</h4>
...
const createCustomerReviewsTemplate = (detailReview) => `<div class="reviews">
     ...
     ${detailReview.customerReviews.map((review) => `<div class="row-review review-customer">
